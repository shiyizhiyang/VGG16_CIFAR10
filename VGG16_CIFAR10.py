...
# With augmentation
dataset_train = torchvision.datasets.CIFAR10("dataset/", train=True, download=True, transform=tranform_train) 
dataset_test = torchvision.datasets.CIFAR10("dataset/", train=False, download=True, transform=tranform_test) 
# import pdb; pdb.set_trace()
